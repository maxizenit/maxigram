...
Бэкенд (этапы 0–8) и экраны фронта готовы; стек поднимается в Docker и проверен живым
end-to-end сценарием (подбор → анонимный чат → real-time → деанонимизация). Открытые пункты —
в [docs/plans/20260628-maxigram-v2.md](docs/plans/20260628-maxigram-v2.md) (Playwright e2e,
просмотр чужого профиля в чате).
