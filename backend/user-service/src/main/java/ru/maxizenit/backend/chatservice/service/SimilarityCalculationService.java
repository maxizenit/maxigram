...
import ru.maxizenit.backend.chatservice.dto.SimilarityCalculation;
...
public class SimilarityCalculationService {
  ...
  @RabbitListener(queues = RabbitParams.SIMILARITY_CALCULATION_REQUEST)
  public void startCalculation(SimilarityCalculationRequest request) {
    ...
    UserProfile firstUserProfile = userProfileService.getUserProfileById(firstUserId);
    UserProfile secondUserProfile = userProfileService.getUserProfileById(secondUserId);
    ...
    rabbitTemplate.convertAndSend(
        ...
        RabbitParams.USER_ACTIONS_FROM_FEED_SERVICE_REQUEST,
  ...
  @RabbitListener(queues = RabbitParams.USER_ACTIONS_FROM_FEED_SERVICE_RESULT)
  ...
  public void endCalculation(SimilarityCalculation calculation) {
    ...
    rabbitTemplate.convertAndSend(
        RabbitParams.EXCHANGE,
        RabbitParams.SIMILARITY_CALCULATION_RESULT,
